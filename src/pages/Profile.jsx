...
const Profile = () => {
  const user = {
    ...
    bio: "Web developer. Coffee enthusiast. Avid traveler.",
  };
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen pt-14 ">
      <div className="bg-white rounded-2xl flex flex-col items-center m-10 p-10 shadow-xl">
        <img src={user.profileImage} alt="Profile" className="w-32 h-32 rounded-full border-4 border-blue-500 mb-4" />
        ...
        <p className="text-center text-gray-700 mt-2 mb-6">{user.bio}</p>
        <h2 className="text-xl font-semibold mt-4">Your Posts</h2>
